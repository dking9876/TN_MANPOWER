...
export async function exportCandidatesToCSV(filters: any) {
    ...
    data.forEach((c: any) => {
        ...
        csvRows.push([
            ...
            c.visa_number || "",
            c.visa_expiry_date || "",
            c.insurance_purchased ? "Yes" : "No",
            c.insurance_purchase_date || "",
            c.flight_date || "",
            c.flight_hour || "",
            c.flight_number || "",
            c.connection_flight_date || "",
            c.connection_flight_hour || "",
            c.connection_flight_number || "",
            c.arrival_date || "",
            c.referrer_got_paid ? "Yes" : "No",
            // Documents
